...
\paragraph{Delineation from a prior sparse-autoencoder study.} One prior paper measures
released and retrained sparse autoencoders with an overlapping toolset and a different
question. \citet{borobia2026pruning} train TopK autoencoders on weight-pruned language models and
ask which features survive compression, using reconstruction and feature-level survival statistics as
the instrument. This paper trains no autoencoder, prunes nothing, and measures no reconstruction. It
