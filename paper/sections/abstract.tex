...
(\SaeDictRgeomMin--\SaeDictRgeomMax): a random code of the same shape carries less cross-talk under
the best linear readout each admits. Autoencoders trained by the same
