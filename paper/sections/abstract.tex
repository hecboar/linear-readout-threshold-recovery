...
The floor then separates what training buys from what comes for free. On \SaeDicts{} released decoder
matrices --- \SaeSaeCount{} sparse-autoencoder decoders plus \SaeMlpCount{} MLP down-projections of
a hybrid model, five families --- all
...
widest run (\ScRegistered{} predicted, \ScMeasured{} measured).
