...
review of the submitted manuscript, after the other six had been written up here, and a second round
of that review --- of the fixes for the first two --- found a ninth defect, in the audit tooling
itself. That sequence is the most useful thing this appendix can tell a reader about how much to
trust the rest. Listing them costs us the appearance of a clean
...
\paragraph{What the pattern says.} Five of the nine defects behind them are the same trap in five different code paths:
