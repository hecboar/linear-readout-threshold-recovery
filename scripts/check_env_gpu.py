...
quietly produces different numbers. This script checks for each, ending with a numerical
equivalence test of the actual training routine against its CPU reference.
...
def main() -> int:
    ...
    gpu = train_toy_models_batched(device="cuda", **kw)
    worst = 0.0
    ...
    print(f"max relative weight difference after 20 steps: {worst:.2e}")
    if worst > 1e-6:
